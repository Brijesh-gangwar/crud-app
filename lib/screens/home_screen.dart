...
//         return (b.priority ?? 0).compareTo(a.priority ?? 0); // Descending priority
//       } else {
//         return b.createdDate.compareTo(a.createdDate); // Recent first
//       }
//     });
...
//                                   _searchQuery = '';
//                                 });
//                                 _searchFocusNode.unfocus(); // Remove cursor
//                               },
//                             )
//                           : null,
//                     ),
...
import 'dart:async';
import 'package:crud_app/main.dart';
import 'package:crud_app/screens/login_screen.dart'; // Make sure this import is correct
import 'package:crud_app/screens/task_form_screen.dart';
import 'package:crud_app/widgets/snakbar_widget.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';
